    ...
    onSubmit={onSubmitHandler} className="flex flex-col min-h-[90vh] justify-center items-center">
      ...
      <div className="flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full">
        <input
          ...
          className="flex-1 bg-transparent outline-none ml-8 text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-400 focus:outline-none focus:placeholder-gray-500 transition-all
              placeholder-color"
        />
        <button
          type="submit"
